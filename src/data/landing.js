...
export const categories = [
  ...
  },
  {
    ...
    img: asset('/category-balcony.webp'),
    imgClass: '',
    to: '/balcony-system',
  },
  {
...
export const bestsellers = [
  {
    ...
    price: 35900,
    img: asset('/white-feather-900-1.webp'),
    hoverImg: asset('/white-feather-900-hover.webp'),
    fit: 'contain',
    bg: '#ffffff',
    hoverBg: '#F84F01',
    specs: [
  ...
  },
  {
    ...
    price: 37990,
    featured: true,
    img: asset('/dark-feather-900-1.webp'),
    hoverImg: asset('/dark-feather-900-hover.webp'),
    fit: 'contain',
    bg: '#ffffff',
    hoverBg: '#FB5804',
    specs: [
  ...
  },
  {
    ...
    price: 93900,
    img: asset('/dark-feather-1800-1.webp'),
    hoverImg: asset('/dark-feather-1800-hover.webp'),
    fit: 'contain',
    bg: '#ffffff',
    hoverBg: '#FA4700',
    specs: [
...
export const founder = {
  ...
  poster: asset('/david-poster.webp'),
};
...
export const panelFaqsTh = [
  {
    q: 'แผง Solvio ใช้เซลล์โซลาร์ประเภทใด?',
    a: 'แผง Solvio ใช้เซลล์โมโนคริสตัลไลน์ชนิด N-type — เทคโนโลยีเซลล์ซิลิคอนรุ่นใหม่ล่าสุด เมื่อเทียบกับแผง P-type รุ่นเก่าที่พบทั่วไปในระบบราคาประหยัด เซลล์ N-type เสื่อมช้ากว่า ทนความร้อนได้ดีกว่า และผลิตไฟได้มากกว่าในแสงน้อย เช่น ช่วงเช้า เย็น หรือวันที่มีเมฆ',
  },
  {
    q: 'ทำไมแผงถึงดูดำสนิทโดยไม่มีเส้นกริดให้เห็น?',
    a: 'เซลล์สีดำล้วน ฟิล์มหุ้มสีดำ และสายไฟบางพิเศษ สร้างพื้นผิวที่สะอาดและสม่ำเสมอ กลมกลืนกับระเบียงและผนังอาคารสมัยใหม่ แทนที่จะดูเหมือน "แผงโซลาร์" ทั่วไป เพื่อนบ้านและเจ้าของที่จะพอใจกับรูปลักษณ์นี้',
  },
  {
    q: 'แผงบางและเบาแค่ไหน?',
    a: 'ลามิเนตกระจก-กระจกบางเพียง 4.75 mm — แผงหลังคาแบบมีกรอบทั่วไปหนาประมาณ 30 mm ด้วยน้ำหนักประมาณครึ่งหนึ่งของโมดูลหลังคามาตรฐาน 21 kg สองคนยกแขวนและปรับตำแหน่งได้สะดวก นั่นคือสิ่งที่ทำให้การติดตั้งระเบียงทำได้จริงและปลอดภัย',
  },
  {
    q: 'แผงทนทานพอสำหรับการใช้งานกลางแจ้งบนระเบียงหรือไม่?',
    a: 'ใช่ โครงสร้างกระจกคู่คีบเซลล์ไว้ระหว่างกระจกนิรภัยลดแสงสองชั้น ซึ่งทนไมโครแคร็ก รอยขีดข่วน และความชื้นได้ดีกว่าแผงที่ใช้แผ่นพลาสติกหลัง แผงรองรับแรงลม 2,400 Pa และทำงานได้ที่อุณหภูมิตั้งแต่ -40°C ถึง +85°C',
  },
  {
    q: 'กำลังผลิตจะเป็นอย่างไรในวันที่ร้อนจัด?',
    a: 'แผงโซลาร์ทุกชนิดสูญเสียกำลังผลิตบางส่วนเมื่ออุณหภูมิสูงขึ้น แผง Solvio มีสัมประสิทธิ์อุณหภูมิ -0.29%/°C เทียบเท่าโมดูล N-type ชั้นนำในตลาด จึงรักษากำลังไฟที่กำหนดได้มากกว่าในช่วงคลื่นความร้อน ตรงกับเวลาที่แอร์คุณต้องการพลังงานมากที่สุด',
  },
];
...
export const landingFaqsTh = [
  {
    q: 'โซลาร์ในประเทศไทยราคาเท่าไหร่?',
    a: 'ชุดระเบียงเริ่มต้นที่ ฿30,750 แบบปลั๊กแอนด์เพลย์ (2 แผง + อินเวอร์เตอร์) ระบบหลังคาแบบเต็มรูปแบบออกแบบตามบ้านของคุณและราคาโปร่งใสเป็นบาทหลังประเมินฟรี ไม่มีค่าใช้จ่ายซ่อนเร้น',
  },
  {
    q: 'คืนทุนเร็วแค่ไหน?',
    a: 'ทั้งชุดระเบียงและระบบหลังคาโดยทั่วไปคืนทุนใน 5–7 ปี ขึ้นอยู่กับการใช้งานและทิศทางการติดตั้ง หลังจากนั้นไฟฟ้าเป็นของฟรีไปอีกหลายทศวรรษ — แผงมีการรับประกันประสิทธิภาพ 30 ปี',
  },
  {
    q: 'หลังคาหรือระเบียง — อันไหนเหมาะกับฉัน?',
    a: 'ระเบียงเริ่มต้นได้เร็ว: ปลั๊กแอนด์เพลย์ตั้งแต่ ฿30,750 ไม่ต้องขออนุญาต ไม่ต้องช่างไฟ และพกพาได้ — เหมาะสำหรับคอนโด ผู้เช่า และบิลไฟที่ไม่สูงมาก หลังคาคือโซลูชันครบวงจร: ออกแบบตามพื้นที่หลังคา ครอบคลุมการใช้ไฟในบ้านได้มากที่สุด เป็นเจ้าของบ้านและต้องการผลสูงสุด? ไปหลังคาเลย ต้องการโซลาร์วันนี้โดยไม่ยุ่งยาก? เริ่มด้วยระเบียงก่อน แล้วค่อยเพิ่มหลังคาทีหลังได้',
  },
  {
    q: 'ต้องขออนุญาตติดตั้งโซลาร์หรือไม่?',
    a: 'ชุดระเบียงและพกพาเสียบปลั๊กได้เลย ไม่ต้องขออนุญาต สำหรับระบบหลังคาที่ต่อเข้ากริด ต้องลงทะเบียนกับ MEA/PEA และเราดูแลเอกสารให้ทั้งหมด',
  },
  {
    q: 'เช่าบ้านหรืออยู่คอนโด ยังใช้โซลาร์ได้ไหม?',
    a: 'ได้เลย — นั่นคือสิ่งที่ชุดระเบียงออกแบบมาเพื่อ ยึดด้วยตะขอโดยไม่เจาะ ไม่แตะตัวอาคาร และพกพาได้เมื่อย้ายที่อยู่',
  },
  {
    q: 'ช่วงฝนตกหนักทำอย่างไร?',
    a: 'แผงยังผลิตไฟได้ในวันที่มีเมฆ แค่น้อยลง ตลอดทั้งปีในไทยแสงแดดมีมากเกินพอที่จะชดเชย และแบตเตอรี่เก็บพลังงานส่วนเกินในช่วงกลางวันไว้ใช้ยามค่ำคืน',
  },
  {
    q: 'แผงทนความร้อนและพายุของไทยได้ไหม?',
    a: 'โมดูลกระจก-กระจกกันน้ำ IP68 รองรับความร้อนสูง ฝนหนัก และอากาศชายฝั่ง',
  },
  {
    q: 'ต้องดูแลรักษาอะไรบ้าง?',
    a: 'แทบไม่ต้องเลย ล้างฝุ่นเป็นครั้งคราว และแอปแจ้งเตือนหากมีความผิดปกติ แผงไม่มีชิ้นส่วนที่เคลื่อนไหว',
  },
];

export const rooftopFaqsTh = [
  {
    q: 'หลังคาของฉันเหมาะสำหรับโซลาร์หรือไม่?',
    a: 'หลังคาส่วนใหญ่ในไทยเหมาะสม ปัจจัยหลักคือทิศทาง (หันใต้ ตะวันออก หรือตะวันตกล้วนได้ผลดีในไทย) ร่มเงาจากต้นไม้หรืออาคารข้างเคียง และสภาพโครงสร้างหลังคา เราประเมินทั้งสามปัจจัยในการสำรวจพื้นที่ฟรีและบอกตรงๆ ว่าโซลาร์คุ้มค่าหรือไม่',
  },
  {
    q: 'กระบวนการทั้งหมดใช้เวลานานแค่ไหน?',
    a: 'ตั้งแต่เซ็นสัญญาจนถึงเปิดใช้งาน โดยทั่วไป 2–4 สัปดาห์ การติดตั้งจริงใช้เวลาเพียง 1–3 วันสำหรับบ้านส่วนใหญ่ ส่วนที่เหลือเป็นการขออนุญาตและกระบวนการมิเตอร์/เชื่อมต่อ PEA/MEA ซึ่งเราดูแลให้ทั้งหมด',
  },
  {
    q: 'ต้องจ่ายเงินทั้งหมดล่วงหน้าไหม?',
    a: 'ไม่ต้อง คุณสามารถจ่ายเต็มจำนวน แบ่งผ่อนกับเรา หรือจัดไฟแนนซ์ผ่านธนาคารพันธมิตร ลูกค้าหลายรายพบว่าค่างวดรายเดือนใกล้เคียงกับที่ประหยัดค่าไฟได้',
  },
  {
    q: 'ต้องขออนุญาตติดโซลาร์บนหลังคาไหม?',
    a: 'ใช่ — ระบบหลังคาที่อยู่อาศัยในไทยต้องลงทะเบียนกับ กกพ. และยื่นขอเชื่อมต่อกับ PEA (หรือ MEA ในกรุงเทพฯ) ข่าวดีคือ Solvio ดูแลเอกสารทั้งหมดให้เป็นส่วนหนึ่งของทุกการติดตั้ง',
  },
  {
    q: 'ขายไฟส่วนเกินคืนกริดได้ไหม?',
    a: 'หากเข้าร่วมโครงการรับซื้อโซลาร์หลังคาของภาครัฐ PEA/MEA จะซื้อไฟส่วนเกินในอัตราราชการ เราจะแนะนำว่าคุ้มค่าสำหรับรูปแบบการใช้ไฟของคุณหรือไม่ และดำเนินการสมัครให้ หมายเหตุ: เงื่อนไขโครงการกำหนดโดย กกพ. และอาจเปลี่ยนแปลงทุกปี',
  },
  {
    q: 'การติดตั้งจะทำให้หลังคาเสียหายไหม?',
    a: 'ไม่ — ช่างเทคนิคที่ผ่านการรับรองของเราใช้ระบบยึดที่ออกแบบสำหรับประเภทหลังคาในไทย (กระเบื้องคอนกรีต CPAC เมทัลชีท) พร้อมกันน้ำทุกจุดยึด รอยเจาะหลังคาถูกซีลและครอบคลุมโดยการรับประกันฝีมือช่างของเรา',
  },
  {
    q: 'ได้รับการรับประกันอะไรบ้าง?',
    a: 'แผงมีการรับประกันประสิทธิภาพ 25 ปี อินเวอร์เตอร์ 10 ปี และงานติดตั้งของเรารับประกัน 2 ปี คุณได้รับเอกสารรับประกันทั้งหมดเมื่อส่งมอบงาน และเคลมผ่านเรา ไม่ต้องติดต่อผู้ผลิตโดยตรง',
  },
];
...
export const portableHeaderSlides = [
  { desktop: asset('/portable-header-5.webp'), mobile: asset('/portable-header-m5-new.webp') },
...
// Technical output/capacity values are verified from the supplied specification labels.
// Prices remain provisional until commercially approved.
export const portableBatteries = [
  { id: 'd100', name: 'Solvio D100', specModel: 'X100', output: '100 W', capacity: '76.8 Wh', price: 6990, img: asset('/portable-100.webp'), sideImg: asset('/portable-100-side.webp'), href: '/portable-system/d100' },
  { id: 'd150', name: 'Solvio D150', specModel: 'X150', output: '150 W', capacity: '153.6 Wh', price: 8300, img: asset('/portable-200.webp'), sideImg: asset('/portable-200-side.webp'), href: '/portable-system/d100?model=d150' },
  { id: 'd300', name: 'Solvio D300', specModel: 'X300', output: '300 W', capacity: '288 Wh', price: 12200, img: asset('/portable-400.webp'), sideImg: asset('/portable-400-side.webp'), imgScale: 'scale-125', href: '/portable-system/d100?model=d300' },
  { id: 'd600', name: 'Solvio D600', specModel: 'X600', output: '600 W', capacity: '512 Wh', price: 20000, img: asset('/portable-600.webp'), sideImg: asset('/portable-600-side.webp'), href: '/portable-system/d100?model=d600' },
  { id: 'd1200', name: 'Solvio D1200', specModel: 'K1200', output: '1,200 W', capacity: '1,008 Wh', price: 36000, img: asset('/portable-1200.webp'), sideImg: asset('/d1200-sideview.webp'), href: '/portable-system/d100?model=d1200' },
  { id: 'd2400', name: 'Solvio D2400', specModel: 'K2400', output: '2,400 W', capacity: '2,160 Wh', price: 64900, img: asset('/portable-2400.webp'), sideImg: asset('/portable-2400-side.webp'), href: '/portable-system/d100?model=d2400' },
];
