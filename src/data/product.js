...
export const product = {
  ...
  taglineTh: 'โซลาร์ระเบียงปลั๊กแอนด์เพลย์ เปลี่ยนราวระเบียงให้เป็นโรงไฟฟ้า',
...
export const cableOptions = [
  { id: 'none', short: 'Without', shortTh: 'ไม่รวมสาย', label: 'Without AC cable', sub: 'Connect with your own cable', price: -700 },
...
export const benefits = [
  ...
  { icon: 'TrendingUp', title: '5–7 year payback', sub: 'Then it is pure free electricity.' },
...
export const testimonials = [
  { name: 'Nok S.', city: 'Bangkok', cityTh: 'กรุงเทพฯ', rating: 5, text: 'Mounted it on my third-floor railing in 25 minutes by myself. The app showed power flowing before I’d even put the ladder away.' },
  { name: 'Tobias K.', city: 'Phuket', cityTh: 'ภูเก็ต', rating: 5, text: 'First full month logged 168 kWh. My electricity bill dropped noticeably and the glass-glass panels look genuinely premium.' },
  { name: 'Priya S.', city: 'Chiang Mai', cityTh: 'เชียงใหม่', rating: 5, text: 'I rent, so no-drill was essential. The hooks clamp tight and nothing touches the building. Landlord had zero objections.' },
  { name: 'Marco B.', city: 'Pattaya', cityTh: 'พัทยา', rating: 4, text: 'Setup was painless. Took off one star only because I wish the longer AC cable came in the box by default.' },
  { name: 'Ploy T.', city: 'Hua Hin', cityTh: 'หัวหิน', rating: 5, text: 'Pairing the Core 1600 battery means we run the fridge and router straight through the evening on yesterday’s sun.' },
  { name: 'Somchai P.', city: 'Krabi', cityTh: 'กระบี่', rating: 5, text: 'Support walked me through registration on a Sunday. 920 kWh in my first year — paying for itself faster than promised.' },
];
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'A south-facing 1.8 kWp kit generates roughly 2,700 kWh per year in Thailand. With about two-thirds of that used at home (more with a battery), that is around ฿7,000–฿8,000 of avoided electricity a year, paying the kit back in about 5–7 years.',
  },
  {
...
export const faqsTh = [
  {
    q: 'ต้องใช้ช่างไฟฟ้าในการติดตั้งไหม?',
    a: 'ไม่ต้อง Balcony Solar เป็นชุดปลั๊กแอนด์เพลย์ คุณยึดรางด้วยมือและเสียบอินเวอร์เตอร์กับปลั๊กกลางแจ้งมาตรฐาน การลงทะเบียนกับผู้ให้บริการกริดเป็นแบบฟอร์มออนไลน์ง่ายๆ ที่เราแนะนำให้',
  },
  {
    q: 'จะพอดีกับระเบียงของฉันไหม?',
    a: 'รางแบบเทเลสโคปิกปรับได้กับราวระเบียงและตะแกรงส่วนใหญ่ที่มีระยะห่างระหว่างแท่ง 60–130 mm ชุดยึดสำหรับสวน หลังคาแบน และผนังอาคารมีให้เลือกในตัวกำหนดค่าด้านบน',
  },
  {
    q: 'ประหยัดได้จริงแค่ไหน?',
    a: 'ชุด 1.8 kWp หันทิศใต้ผลิตได้ประมาณ 2,700 kWh ต่อปีในประเทศไทย ประมาณสองในสามของนั้นใช้ที่บ้าน (มากกว่าถ้ามีแบตเตอรี่) คิดเป็นประมาณ ฿7,000–฿8,000 ต่อปีที่ประหยัดได้ คืนทุนใน 5–7 ปี',
  },
  {
    q: 'วันที่มีเมฆหรือตอนกลางคืนจะเป็นอย่างไร?',
    a: 'โมดูลยังผลิตไฟได้ในวันที่มีเมฆ แค่น้อยลง ตอนกลางคืนเพิ่มแบตเตอรี่ Solvio Core เพื่อเก็บพลังงานส่วนเกินในช่วงกลางวันไว้ใช้หลังพระอาทิตย์ตก',
  },
  {
    q: 'กันน้ำได้ไหม?',
    a: 'ใช่ โมดูลกระจก-กระจกมีกล่องต่อสาย IP68 ทนอุณหภูมิตั้งแต่ −40°C ถึง +85°C ผ่านการทดสอบลูกเห็บ ลม และละอองน้ำเกลือ ทุกชิ้นส่วนภายนอกทนรังสี UV',
  },
  {
    q: 'การรับประกันครอบคลุมอะไรบ้าง?',
    a: 'โมดูลมีการรับประกันประสิทธิภาพ 30 ปี (87.4% ที่ปีที่ 30) และรับประกันผลิตภัณฑ์ 15 ปี ไมโครอินเวอร์เตอร์รับประกัน 12 ปี',
  },
];
