          ...
          {open && (
            ...
            >
              <motion.div
                role="dialog"
                aria-modal="true"
                aria-label={th ? 'สมาชิก Bgreenie' : 'Bgreenie Membership'}
              ...
              >
                ...
                <h3 className="mt-4 font-display text-xl font-extrabold text-ink">
                  {th ? 'สมาชิก Bgreenie' : 'Bgreenie Membership'}
                </h3>
                <p className="mt-3 text-[15px] leading-relaxed text-slatey-500">
                  {th
                    ? 'Solvio ร่วมมือกับ Bgreenie เพื่อให้ทุกคนเข้าถึงพลังงานโซลาร์ได้ง่ายขึ้น สมาชิกจะได้รับส่วนลดพิเศษสำหรับผลิตภัณฑ์โซลาร์และโอกาสร่วมแบ่งปันรายได้กับชุมชน'
                    : 'Solvio has teamed up with Bgreenie to democratize solar energy. Members get exclusive discounts on solar products and access to community revenue-sharing opportunities.'}
                </p>
                ...
                <div className="mt-6 flex flex-col gap-2.5 sm:flex-row-reverse">
                  ...
                  >
                    {th ? 'ไปต่อที่ Bgreenie' : 'Continue to Bgreenie'} <ArrowRight size={16} />
                  </a>
                  <button
                    type="button"
                    onClick={() => setOpen(false)}
