            ...
            <Reveal>
              <div className="max-w-2xl">
                ...
                <p className="mt-5 text-lg leading-relaxed text-white/70">
                  Steel plants, curved granary roofs, hospital walkways, greenhouses and city streets. These are reference installations delivered with our manufacturing partner — the same ultra-lightweight technology behind every Solvio system.
                </p>
                <a href="#contact" className="mt-7 inline-flex items-center gap-2 rounded-full bg-lime px-6 py-3.5 font-display text-base font-bold text-white transition hover:bg-lime-dark">
