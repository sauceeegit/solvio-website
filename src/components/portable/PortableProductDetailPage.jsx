              ...
              <aside className="self-start lg:sticky lg:top-32">
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-lime bg-white px-6 py-3.5 font-display text-sm font-semibold text-lime transition hover:bg-lime/5 active:scale-95"
                  >
