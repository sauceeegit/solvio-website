          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="mb-1 flex items-center justify-between">
                <label className="font-display text-sm font-semibold text-ink">Household use</label>
                <span className="font-mono text-sm font-semibold text-ink">{num(household)} kWh/yr</span>
              </div>
              <input
                type="range"
                min="1000"
                ...
                className="w-full accent-lime-dark"
              />
            </div>

            <div>
              <div className="mb-1 flex items-center justify-between">
                <label className="font-display text-sm font-semibold text-ink">Electricity price</label>
