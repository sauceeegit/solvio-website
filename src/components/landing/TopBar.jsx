      ...
      <div className="container-x flex items-center justify-between gap-4 py-2">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-1.5 font-display text-[0.7rem] font-medium text-neutral-500 transition hover:text-neutral-800"
          >
            <Phone size={12} />
            {topBar.phone}
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden items-center gap-1.5 font-display text-[0.7rem] font-medium text-neutral-500 transition hover:text-neutral-800 sm:inline-flex"
          >
        ...
        <div className="flex items-center gap-3">
          <SocialIcon label="WhatsApp" href="https://wa.me/66843488428">
          ...
          <SocialIcon label="LINE" href={LINE_URL}>
          ...
          <SocialIcon label="Telegram" href={TELEGRAM_URL}>
