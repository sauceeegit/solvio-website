...
// WhatsApp booking link for "Book a consultation appointment".
const WA_CONSULT = `https://wa.me/66843488428?text=${encodeURIComponent(
  "Hi Solvio — I'd like to book a consultation appointment.",
)}`;
const FACEBOOK_URL = 'https://www.facebook.com/profile.php?id=61589293775189';
const LINE_URL = 'https://line.me/R/ti/p/@250wcgbc';
const TELEGRAM_URL = 'https://t.me/solviosolar';

// Social chip — coloured in the platform's own brand colour with a white glyph.
function Social({ label, href = '#', color, children }) {
...
export default function TopBar() {
  return (
    <div className="text-white" style={{ backgroundColor: '#040f08' }}>
      <div className="container-x flex flex-wrap items-center justify-between gap-x-4 gap-y-2 py-2.5">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-lime px-3.5 py-1.5 font-display text-[0.7rem] font-bold text-white"
          >
        ...
        <div className="flex items-center gap-2.5">
          <Social label="WhatsApp" href="https://wa.me/66843488428" color="#25D366">
          ...
          <Social label="Facebook" href={FACEBOOK_URL} color="#1877F2">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </Social>
          <Social label="LINE" href={LINE_URL} color="#06C755">
          ...
          <Social label="Telegram" href={TELEGRAM_URL} color="#229ED9">
