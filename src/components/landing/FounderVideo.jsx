    ...
    <section className="bg-surface py-16">
      <div className="container-x grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <Reveal delay={0.1}>
          ...
          <h2 className="mt-2 font-display text-2xl font-medium leading-tight tracking-tight text-ink sm:text-3xl max-sm:text-[22px]" style={{ fontFamily: '"Space Grotesk", system-ui, sans-serif' }}>
            {founder.heading}
          </h2>
