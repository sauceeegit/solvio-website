...
const contactCopy = {
  ...
  th: {
    eyebrow: 'ติดต่อเรา',
    heading: 'คุยกับผู้เชี่ยวชาญด้านโซลาร์ของ Solvio',
    tagline: 'บอกเราว่าคุณต้องการอะไรสำหรับบ้านหรือธุรกิจของคุณ เราพร้อมให้คำแนะนำที่เหมาะกับคุณ อย่างตรงไปตรงมา โดยไม่มีข้อผูกมัด เราจะติดต่อกลับโดยเร็ว',
